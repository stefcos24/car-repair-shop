...
urlpatterns = [
    ...
    path('customer/<str:customer_id>', customer.get_or_update_customer_details, name="customer"),
    path('customer/<str:customer_id>/delete', customer.delete_customer, name="customer_delete"),
]
